...
function render(){
  ...
  $('score-note').textContent=position==='DST'?'D/ST uses an explicit scoreboard-points-allowed preset; platform scoring may differ. See Method & sources.':
